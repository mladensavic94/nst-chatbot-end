...
public class AppointmentsService {
    ...
    public void updateDateTime(Appointment appointment) {
        ...
        if(appointments == null || appointments.size() <= 1){
            ...
            cal.setTime(appointments.get(appointments.size() - 1).getDateAndTime());
            cal.add(Calendar.MINUTE, appointments.get(appointments.size() - 1).getLength() == null? 0 : appointments.get(appointments.size() - 1).getLength());
